...
3. Implement the customizer settings panel and theme toggling standard.
4. Improve design detailing (transitions, premium micro-animations) to make it look premium and state-of-the-art.
...
- [x] Settings modal implemented with Theme toggling, BG URL, Opacity, Blur
- [x] Fullscreen toggle button moved to Settings modal and functional
